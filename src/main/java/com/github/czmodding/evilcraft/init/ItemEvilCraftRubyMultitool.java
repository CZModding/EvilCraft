...
public class ItemEvilCraftRubyMultitool extends ItemPickaxe{
	...
	protected ItemEvilCraftRubyMultitool(String unlocalizedName, ToolMaterial material) {
        super(material);
        this.setUnlocalizedName(unlocalizedName);
        this.setTextureName(Reference.MODID + ":" + unlocalizedName);
        
        Set effectiveAgainst = Sets.newHashSet(new Block[] {
